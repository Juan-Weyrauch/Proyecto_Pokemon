...
public static class Create
{
    ...
    public static Dictionary<int, IPokemon> CreateCatalogue()
    {
        ...
        Pokedex.Add(5,
            new Pokemon("Pikachu", 11, "Electric", AttackGenerator.GenerateRandomAttack("Electric")));
        ...
        Pokedex.Add(10,
            new Pokemon("Alakazam", 15, "Psychic", AttackGenerator.GenerateRandomAttack("Psychic")));
        ...
        Pokedex.Add(17,
            new Pokemon("Jolteon", 17, "Electric", AttackGenerator.GenerateRandomAttack("Electric")));
        ...
        Pokedex.Add(20,
            new Pokemon("Aerodactyl", 18, "Flying", AttackGenerator.GenerateRandomAttack("Flying")));
