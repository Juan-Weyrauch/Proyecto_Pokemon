            ...
            var attacksByType = new Dictionary<string, List<IAttack>>()
{
    ...
    { "Water", new List<IAttack>
        {
            new Attack("Water Gun", 10, SpecialEffect.Sleep, "Water", 100),
            new Attack("Hydro Pump", 35, SpecialEffect.Sleep, "Water", 95),
    ...
    { "Bug", new List<IAttack>
        {
            ...
            new Attack("Signal Beam", 35, SpecialEffect.Paralyze, "Bug", 90),
            new Attack("X-Scissor", 60, SpecialEffect.None, "Bug", 90)
        }
    },
    { "Dragon", new List<IAttack>
        {
            new Attack("Dragon Claw", 10, SpecialEffect.Burn, "Dragon", 100),
            new Attack("Dragon Tail", 35, SpecialEffect.Burn, "Dragon", 95),
            new Attack("Draco Meteor", 60, SpecialEffect.Burn, "Dragon", 90)
        }
    },
    { "Electric", new List<IAttack>
        {
            new Attack("Thunder Shock", 10, SpecialEffect.Paralyze, "Electric", 95),
            new Attack("Spark", 35, SpecialEffect.Paralyze, "Electric", 95),
            new Attack("Thunderbolt", 60, SpecialEffect.Paralyze, "Electric", 90)
        }
    },
    { "Ghost", new List<IAttack>
        {
            new Attack("Shadow Ball", 10, SpecialEffect.Poison, "Ghost", 100),
    ...
    { "Fire", new List<IAttack>
        {
            new Attack("Ember", 10, SpecialEffect.Burn, "Fire", 95),
            new Attack("Flamethrower", 35, SpecialEffect.Burn, "Fire", 90),
            new Attack("Fire Blast", 60, SpecialEffect.Burn, "Fire", 85)
        }
    },
    { "Ice", new List<IAttack>
        {
            new Attack("Ice Shard", 10, SpecialEffect.Paralyze, "Ice", 90),
            new Attack("Blizzard", 35, SpecialEffect.Poison, "Ice", 95),
            new Attack("Frost Breath", 60, SpecialEffect.None, "Ice", 90)
        }
    },
    { "Fight", new List<IAttack>
        {
            new Attack("Karate Chop", 10, SpecialEffect.None, "Fight", 100),
            new Attack("Dynamic Punch", 35, SpecialEffect.Sleep, "Fight", 90),
            new Attack("Close Combat", 60, SpecialEffect.None, "Fight", 90)
        }
    },
    { "Normal", new List<IAttack>
        {
            new Attack("Tackle", 10, SpecialEffect.None, "Normal", 100),
            new Attack("Body Slam", 35, SpecialEffect.Sleep, "Normal", 95),
            new Attack("Hyper Beam", 60, SpecialEffect.None, "Normal", 90)
        }
    },
    { "Psychic", new List<IAttack>
        {
            new Attack("Psybeam", 10, SpecialEffect.Paralyze, "Psychic", 100),
    ...
    { "Rock", new List<IAttack>
        {
            new Attack("Rock Throw", 10, SpecialEffect.Sleep, "Rock", 100),
    ...
    { "Earth", new List<IAttack>
        {
            new Attack("Mud-Slap", 10, SpecialEffect.Paralyze, "Earth", 100),
            new Attack("Earthquake", 35, SpecialEffect.Paralyze, "Earth", 95),
            new Attack("Bulldoze", 60, SpecialEffect.None, "Earth", 90)
        }
    },
    { "Venom", new List<IAttack>
        {
            new Attack("Poison Sting", 10, SpecialEffect.Poison, "Venom", 90),
            new Attack("Sludge Bomb", 35, SpecialEffect.Poison, "Venom", 90),
    ...
    { "Flying", new List<IAttack>
        {
            ...
            new Attack("Aerial Ace", 35, SpecialEffect.Sleep, "Flying", 95),
            new Attack("Sky Attack", 60, SpecialEffect.None, "Flying", 90)
        }
    }
};
