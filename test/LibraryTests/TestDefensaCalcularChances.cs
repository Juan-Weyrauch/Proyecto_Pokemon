  ...
  static  public class CalcularChances
    {
        ...
        static public void TestFaltaItems()
        {
            ...
            Player.InitializePlayer1("example", Poke1, Poke1[1]);
            Player.InitializePlayer2("example", Poke2, Poke2[3]);
        ...
        [Test]
        static public void TestPokemonMuerto()
        {
            ...
            Player.InitializePlayer1("example", Poke1, Poke1[1]);
            Player.InitializePlayer2("example", Poke2, Poke2[2]);

            IPlayer p1 = Player.Player1;
            IPlayer p2 = Player.Player2;
            p2.Pokemons[0].Health = 0;
            Assert.That(Calculator.FuncionCalcularChances(p1,p2).Equals("P1 gano con 100 y P2 tiene 90")); //P1 gano con 100 y P2 tiene 90
